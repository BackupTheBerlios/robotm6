...
static BumperMappingStruct BumpersMapping[BUMPERS_NBR]= {
    ...
    true},
    {BUTTON_NO,     "Button No",       EVENTS_BUTTON_NO,       false, 1, 3,
    true},
    {SWITCH_MATCH,  "Switch Match",    EVENTS_GROUP_NONE,      false, 2, 0,
    true},
    {SWTICH_REBOOT, "Switch Reboot",   EVENTS_SWITCH_REBOOT,   false, 1, 2,
    true},
    {EMERGENCY_STOP,"Emergency Stop",  EVENTS_EMERGENCY_STOP,  true, 1, 1,
    true},
    {START_JACK,    "Start Jack",      EVENTS_JACKIN,          true, 1, 0,
    true},
