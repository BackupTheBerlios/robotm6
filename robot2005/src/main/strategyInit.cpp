...
// -------------------------------------------------------------------------
// StrategyCL::unlockEmergencyStop
// -------------------------------------------------------------------------
void StrategyCL::unlockEmergencyStop()
{
...
// -------------------------------------------------------------------------
// StrategyCL::checkOdometer
// -------------------------------------------------------------------------
bool StrategyCL::checkOdometer()
{
...
// -------------------------------------------------------------------------
// StrategyCL::checkBumper
// -------------------------------------------------------------------------
bool StrategyCL::checkBumper()
{
#ifdef LSM_TODO
...
bool evtRebootSwitch(bool evt[]) 
{
  return (evt[EVENTS_BUTTON_YES] 
	  ...
	  || evt[EVENTS_SWITCH_DEGRADED]);
}

// ---------------------------------------------------------------------------
// StrategyCL::checkRebootSwitch
// ---------------------------------------------------------------------------
bool StrategyCL::checkRebootSwitch()
{
#ifdef LSM_TODO
    LOG_COMMAND("== checkRebootSwitch ==\n");
    bool retry=true;
    while (!StrategyCLDegraded::isMatchSwitchSet() && retry) { 
...
// ---------------------------------------------------------------------------
// StrategyCL::testUARTCom
// ---------------------------------------------------------------------------
// Verifie que les cartes UART pinguent
// ---------------------------------------------------------------------------
void StrategyCL::testUARTCom()
{
    checkLcd();
    checkOdometer();
    checkBumper();
...
// -------------------------------------------------------------------------
// StrategyCL::autoCheck
// -------------------------------------------------------------------------
bool StrategyCL::autoCheck()
{
...
// -------------------------------------------------------------------------
// StrategyCL::waitJackout
// -------------------------------------------------------------------------
bool StrategyCL::waitJackout()
{
