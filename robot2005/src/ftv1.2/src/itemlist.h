...
/***************************************************************/
typedef struct item_cell_st *item_cell_t;
typedef struct item_list_st *item_list_t;
...
item_cell_t    _append_item_list      (item_list_t,void*);
...
void           _reinsert_cell         (item_list_t,
				       item_cell_t,
				       int preserve_order);
void           _extract               (item_list_t,item_cell_t);
