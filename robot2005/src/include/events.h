...
typedef enum EventsEnum {
    ...
    EVENTS_NO_BRIDGE_BUMP_LEFT,
    EVENTS_NO_BRIDGE_BUMP_RIGHT,
...
static EventsInfoStruct EventsInfo[EVENTS_NBR] = {  
    ...
    { EVENTS_NO_BRIDGE_BUMP_LEFT, "EVT_NO_BRIDGE_BUMP_LEFT", EVENTS_GROUP_BRIDGE }, 
    { EVENTS_NO_BRIDGE_BUMP_RIGHT,"EVT_NO_BRIDGE_BUMP_RIGHT",EVENTS_GROUP_BRIDGE }, 
