...
typedef enum EventsEnum {
    ...
    EVENTS_PLAYING_SOUND,

    EVENTS_BUTTON_YES,
    EVENTS_BUTTON_NO,
    EVENTS_IPAQ_BUTTON_YES,
    EVENTS_IPAQ_BUTTON_NO,

    EVENTS_SWITCH_MATCH,
    EVENTS_SWITCH_DEGRADED,

    EVENTS_GAME_OVER,      // timer fin du match
    EVENTS_TIMER_ALERT,    // timer, proche de la fin du match
    EVENTS_LASER_CUT,      // un laser vient d'etre coupé
...
static EventsInfoStruct EventsInfo[EVENTS_NBR] = {  
    ...
    { EVENTS_GROUP_GONIO,  "EVT_GROUP_GONIO", EVENTS_GROUP_NONE},
    ...
    { EVENTS_PLAYING_SOUND,  "EVT_PLAYING_SOUND",   EVENTS_GROUP_NONE},
    { EVENTS_BUTTON_YES,     "EVT_BUTTON_YES",      EVENTS_GROUP_USER  },  
    { EVENTS_BUTTON_NO,      "EVT_BUTTON_NO",       EVENTS_GROUP_USER  },   
    { EVENTS_IPAQ_BUTTON_YES,"EVT_IPAQ_BUTTON_YES", EVENTS_GROUP_USER  },
    { EVENTS_IPAQ_BUTTON_NO, "EVT_IPAQ_BUTTON_NO",  EVENTS_GROUP_USER  }, 
    { EVENTS_SWITCH_MATCH,   "EVT_SWITCH_MATCH",    EVENTS_GROUP_USER  },
    { EVENTS_SWITCH_DEGRADED,"EVT_SWITCH_DEGRADED", EVENTS_GROUP_USER  },
